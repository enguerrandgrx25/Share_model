...
st.subtitle("Concept de départ (0 - 30 points)")
...
st.subtitle("Validation du concept (entre 0 et 120 points) ")
...
st.subtitle("Rôles techniques (entre 70 et 130 points) et rôles généralistes (entre 90 et 110 points)")
