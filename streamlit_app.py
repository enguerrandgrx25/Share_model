...
st.error("""Le but de cet exercice est d'aborder des sujets important pour le succès de l'entreprise. Ces sujets ne sont pas forcement facile a aborder mais ils sont indispensablent""")
